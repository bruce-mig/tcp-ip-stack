 ...
 *       Filename:  net.h
 *
 *    Description:  This file contains all definitions for structures required
...
typedef struct intf_nw_props_ {
   ...
   intf_l2_mode_t intf_l2_mode; /*if IP-address is configured on this interface,
                                   then this should be set to UNKNOWN*/
   unsigned int vlans[MAX_VLAN_MEMBERSHIP]; /*If the interface is operating in
                                               Trunk mode, it can be a member of
                                               these many vlans*/
...
bool_t is_trunk_interface_vlan_enabled(interface_t *interface,
