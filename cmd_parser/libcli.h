...
param_t *libcli_get_debug_hook(void);

param_t *libcli_get_debug_show_hook(void);

param_t *libcli_get_config_hook(void);

param_t *libcli_get_clear_hook(void);
...
void init_param(param_t *param, param_type_t param_type, char *cmd_name,
                cmd_callback callback,
                user_validation_callback user_validation_cb_fn,
                leaf_type_t leaf_type, char *leaf_id, char *help);
